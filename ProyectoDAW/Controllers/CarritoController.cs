...
namespace ProyectoDAW.Controllers
{
    ...
    public class CarritoController : ControllerBase
    {
        ...
        [HttpPost("{productoId}/{precioCarrito}/{estadoCarritoEnum}")]
        public async Task<IActionResult> Post(Producto producto, int precioCarrito, EstadoCarritoEnum estadoCarritoEnum)
        {
            try
            {
